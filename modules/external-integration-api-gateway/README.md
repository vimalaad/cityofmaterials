...
## Overview
A centralized gateway managing all third-party service integrations including OpenRouter for LLM access, news APIs, and text-to-speech providers. Handles API keys, rate limiting, retries, and error logging.
